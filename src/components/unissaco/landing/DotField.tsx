...
const DotField = memo(({
  ...
  const propsRef = useRef<Record<string, unknown>>({ dotRadius, dotSpacing, cursorRadius, cursorForce, bulgeOnly, bulgeStrength, sparkle, waveAmplitude, gradientFrom, gradientTo });
